...
def model_setup(num_labels, model_select, device, config, gen, dropout, dropoutrest=0):
    ...
    elif model_select == 'Bart-MNLI':
        model = modeling.bart_mnli_classifier(num_labels, model_select, gen, dropout).to(device)
